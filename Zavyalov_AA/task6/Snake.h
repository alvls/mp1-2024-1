...
public:
	...
	COORD getHead() { // дл€ class game, дл€ проверки на то можно ли ехать куда-то (не стена ли там)
		return head;
	}
	std::vector<COORD> getBody() { // дл€ проверки на то, можно ли создать еду в клетке
		return body;
	}
