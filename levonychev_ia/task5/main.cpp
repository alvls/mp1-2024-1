...
int main()
{
    ...
    Hall hall1(1, 15, 15);
    Hall hall2(2, 14, 10);
    MovieSession movie_session1({ 22, 4, 24 }, { 18, 0 }, "Avatar", hall2, 250);
    MovieSession movie_session2({ 22, 4, 24 }, { 23, 15 }, "Catch me if you can", hall2, 300);
    ...
    //double price2 = ticket_office.buy_tickets({22, 4, 24}, {18, 0}, "Avatar", 2, 0, 9);
    //double price3 = ticket_office.buy_tickets({ 22, 4, 24 }, { 18, 0 }, "Avatar", 2, 0, 2);
    double price4 = ticket_office.buy_tickets({ 22, 4, 24 }, { 18, 0 }, "Avatar", 2, 0, 10);
    ticket_office.cancel_order(movie_session1, 10);
    system("pause");
    return 0;
}
